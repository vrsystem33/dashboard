...
export class CategoryDialogComponent implements OnChanges {
  @Input() visible = false;
  @Input() category: UserCategory | null = null;
  @Output() save = new EventEmitter<UserCategoryCreateRequestDto | UserCategoryUpdateRequestDto>();
  ...
  private buildPayload(): UserCategoryCreateRequestDto | UserCategoryUpdateRequestDto {
    ...
    return cleaned as UserCategoryCreateRequestDto | UserCategoryUpdateRequestDto;
  }
}
