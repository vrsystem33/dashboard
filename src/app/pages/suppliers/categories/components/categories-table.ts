...
import { SupplierCategory } from '../../supplier-categories.service';
...
export class CategoriesTableComponent {
  ...
  @Output() edit = new EventEmitter<SupplierCategory>();
  @Output() delete = new EventEmitter<SupplierCategory>();
  ...
  onSelectionChange(selected: SupplierCategory[]) {
