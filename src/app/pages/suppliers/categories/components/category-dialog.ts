...
export class CategoryDialogComponent implements OnChanges {
  @Input() visible = false;
  @Input() category: SupplierCategory | null = null;
  @Output() save = new EventEmitter<SupplierCategoryCreateRequestDto | SupplierCategoryUpdateRequestDto>();
  ...
  private buildPayload(): SupplierCategoryCreateRequestDto | SupplierCategoryUpdateRequestDto {
    ...
    return cleaned as SupplierCategoryCreateRequestDto | SupplierCategoryUpdateRequestDto;
  }
}
