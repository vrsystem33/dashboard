...
export class SupplierCategoriesPage implements OnInit {
  ...
  constructor(
    private service: SupplierCategoriesService,
  ...
  openEdit(category: SupplierCategory) {
  ...
  save(payload: SupplierCategoryCreateRequestDto | SupplierCategoryUpdateRequestDto) {
    ...
    if (isEdit && target?.id) {
      ...
      this.service.create(payload as SupplierCategoryCreateRequestDto).pipe(take(1)).subscribe(() => {
  ...
  confirmDelete(category: SupplierCategory) {
