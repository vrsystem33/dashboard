  ...
  template: `
    <p-toolbar class="mb-6 md:flex" *ngIf="!mobile()">
      <ng-template #start>
        ...
        <button pButton type="button" label="Transportadoras" icon="pi pi-truck" class="p-button-outlined shrink-0" (click)="this.openCarriers()"></button>
      </ng-template>
