...
export class CategoryDialogComponent implements OnChanges {
  @Input() visible = false;
  @Input() category: CarrierCategory | null = null;
  @Output() save = new EventEmitter<CarrierCategoryCreateRequestDto | CarrierCategoryUpdateRequestDto>();
  ...
  private buildPayload(): CarrierCategoryCreateRequestDto | CarrierCategoryUpdateRequestDto {
    ...
    return cleaned as CarrierCategoryCreateRequestDto | CarrierCategoryUpdateRequestDto;
  }
}
