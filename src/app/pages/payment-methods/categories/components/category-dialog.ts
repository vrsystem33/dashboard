...
export class CategoryDialogComponent implements OnChanges {
  @Input() visible = false;
  @Input() category: CustomerCategory | null = null;
  @Output() save = new EventEmitter<CustomerCategoryCreateRequestDto | CustomerCategoryUpdateRequestDto>();
  ...
  private buildPayload(): CustomerCategoryCreateRequestDto | CustomerCategoryUpdateRequestDto {
    ...
    return cleaned as CustomerCategoryCreateRequestDto | CustomerCategoryUpdateRequestDto;
  }
}
